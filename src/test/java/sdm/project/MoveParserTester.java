...
public class MoveParserTester {
    ...
    void testGetRow(int row, int column, Symbol symbol, String moveLine) throws WrongNumberOfArgumentsException, BoardIndexOutOfBoundsException, IllegalSymbolException {
